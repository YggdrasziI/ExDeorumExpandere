...
public class CreativeMechanicalSieveMenu extends AbstractMachineMenu<CreativeMechanicalSieveBlockEntity> {
    ...
    public CreativeMechanicalSieveMenu(int containerId, Inventory playerInventory, FriendlyByteBuf data) {
        this(containerId, playerInventory, (CreativeMechanicalSieveBlockEntity) readPayload(playerInventory, data));
    }

    public CreativeMechanicalSieveMenu(int containerId, Inventory playerInventory, CreativeMechanicalSieveBlockEntity sieve) {
        super(ModMenu.CREATIVE_MECHANICAL_SIEVE.get(), containerId, playerInventory, sieve);
