...
public class DiamondMechanicalSieveMenu extends AbstractMachineMenu<DiamondMechanicalSieveBlockEntity> {
    ...
    public DiamondMechanicalSieveMenu(int containerId, Inventory playerInventory, FriendlyByteBuf data) {
        this(containerId, playerInventory, (DiamondMechanicalSieveBlockEntity) readPayload(playerInventory, data));
    }

    public DiamondMechanicalSieveMenu(int containerId, Inventory playerInventory, DiamondMechanicalSieveBlockEntity sieve) {
        super(ModMenu.DIAMOND_MECHANICAL_SIEVE.get(), containerId, playerInventory, sieve);
