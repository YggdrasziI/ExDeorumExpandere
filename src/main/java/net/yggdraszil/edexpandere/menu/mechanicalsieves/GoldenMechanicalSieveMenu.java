...
public class GoldenMechanicalSieveMenu extends AbstractMachineMenu<GoldenMechanicalSieveBlockEntity> {
    ...
    public GoldenMechanicalSieveMenu(int containerId, Inventory playerInventory, FriendlyByteBuf data) {
        this(containerId, playerInventory, (GoldenMechanicalSieveBlockEntity) readPayload(playerInventory, data));
    }

    public GoldenMechanicalSieveMenu(int containerId, Inventory playerInventory, GoldenMechanicalSieveBlockEntity sieve) {
        super(ModMenu.GOLDEN_MECHANICAL_SIEVE.get(), containerId, playerInventory, sieve);
