...
public class DiamondMechanicalSieveBlockEntity extends AbstractMachineBlockEntity<DiamondMechanicalSieveBlockEntity> implements SieveLogic.Owner {
    private static final Component TITLE = Component.translatable("edexpandere.container.diamond_mechanical_sieve");
    ...
    public DiamondMechanicalSieveBlockEntity(BlockPos pos, BlockState state) {
        super(ModBlockEntities.DIAMOND_MECHANICAL_SIEVE.get(), pos, state, ItemHandler::new, ExpandereConfig.diamond_mechanical_sieve_energyStorage);
