...
public class NetheriteMechanicalSieveBlockEntity extends AbstractMachineBlockEntity<NetheriteMechanicalSieveBlockEntity> implements SieveLogic.Owner {
    private static final Component TITLE = Component.translatable("edexpandere.container.netherite_mechanical_sieve");
    ...
    public NetheriteMechanicalSieveBlockEntity(BlockPos pos, BlockState state) {
        super(ModBlockEntities.NETHERITE_MECHANICAL_SIEVE.get(), pos, state, ItemHandler::new, ExpandereConfig.netherite_mechanical_sieve_energyStorage);
        this.energyHelper = new EnergyHelper(ExpandereConfig.netherite_mechanical_sieve_energyStorage);
    }
    ...
    protected void runMachineTick() {
        this.logic.sift((float) ExpandereConfig.netherite_mechanical_sieve_speed, Long.MAX_VALUE);
    }

    protected int getEnergyConsumption() {
        return ExpandereConfig.netherite_mechanical_sieve_energyConsumption;
    }
