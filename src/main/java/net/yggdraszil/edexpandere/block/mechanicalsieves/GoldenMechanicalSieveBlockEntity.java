...
public class GoldenMechanicalSieveBlockEntity extends AbstractMachineBlockEntity<GoldenMechanicalSieveBlockEntity> implements SieveLogic.Owner {
    private static final Component TITLE = Component.translatable("edexpandere.container.golden_mechanical_sieve");
    ...
    public GoldenMechanicalSieveBlockEntity(BlockPos pos, BlockState state) {
        super(ModBlockEntities.GOLDEN_MECHANICAL_SIEVE.get(), pos, state, ItemHandler::new, ExpandereConfig.golden_mechanical_sieve_energyStorage);
        this.energyHelper = new EnergyHelper(ExpandereConfig.golden_mechanical_sieve_energyStorage);
    }
    ...
    protected void runMachineTick() {
        this.logic.sift((float) ExpandereConfig.golden_mechanical_sieve_speed, Long.MAX_VALUE);
    }

    protected int getEnergyConsumption() {
        return ExpandereConfig.golden_mechanical_sieve_energyConsumption;
    }
