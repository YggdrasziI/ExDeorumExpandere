...
public class CreativeMechanicalSieveBlockEntity extends AbstractMachineBlockEntity<CreativeMechanicalSieveBlockEntity> implements SieveLogic.Owner {
    private static final Component TITLE = Component.translatable("edexpandere.container.creative_mechanical_sieve");
    ...
    public CreativeMechanicalSieveBlockEntity(BlockPos pos, BlockState state) {
        super(ModBlockEntities.CREATIVE_MECHANICAL_SIEVE.get(), pos, state, ItemHandler::new, ExpandereConfig.creative_mechanical_sieve_energyStorage);
        this.energyHelper = new EnergyHelper(ExpandereConfig.creative_mechanical_sieve_energyStorage);
    }
