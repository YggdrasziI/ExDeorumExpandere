...
import net.cathienova.havenede.block.mechanicalhammers.NetheriteMechanicalHammerBlockEntity;
...
public class NetheriteMechanicalHammerMenu extends AbstractMachineMenu<NetheriteMechanicalHammerBlockEntity> {
    ...
    @ObjectHolder(registryName = "minecraft:menu", value = "havenede:netherite_mechanical_hammer")
    public static final MenuType<NetheriteMechanicalHammerMenu> NETHERITE_MECHANICAL_HAMMER = null;

    public NetheriteMechanicalHammerMenu(int containerId, Inventory playerInventory, FriendlyByteBuf data) {
        this(containerId, playerInventory, (NetheriteMechanicalHammerBlockEntity) readPayload(playerInventory, data));
    }

    public NetheriteMechanicalHammerMenu(int containerId, Inventory playerInventory, NetheriteMechanicalHammerBlockEntity machine) {
        super(NETHERITE_MECHANICAL_HAMMER, containerId, playerInventory, machine);
    ...
    public ItemStack quickMoveStack(Player player, int clickedSlot) {
        ...
        if (slot.hasItem()) {
            ...
            } else if (NetheriteMechanicalHammerBlockEntity.isValidInput(clickedStack)) {
    ...
    private class ProgressDataSlot extends DataSlot {
        @Override
        public int get() {
            return NetheriteMechanicalHammerMenu.this.machine.getProgress();
        }

        @Override
        public void set(int value) {
            NetheriteMechanicalHammerMenu.this.machine.setProgress(value);
        }
    }
    ...
    private class EnergyDataSlot extends DataSlot {
        @Override
        public int get() {
            return NetheriteMechanicalHammerMenu.this.machine.getEnergyStored();
        }

        @Override
        public void set(int value) {
            NetheriteMechanicalHammerMenu.this.machine.energy.setStoredEnergy(value);
        }
    }
    ...
    private class RedstoneModeDataSlot extends DataSlot {
        @Override
        public int get() {
            return NetheriteMechanicalHammerMenu.this.machine.getRedstoneMode();
        }

        @Override
        public void set(int value) {
            NetheriteMechanicalHammerMenu.this.machine.setRedstoneMode(value);
        }
    }
