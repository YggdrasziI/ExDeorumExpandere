...
import net.cathienova.havenede.menu.mechanicalsieves.GoldenMechanicalSieveMenu;
...
public class GoldenMechanicalSieveBlockEntity extends AbstractMachineBlockEntity<GoldenMechanicalSieveBlockEntity> implements SieveLogic.Owner {
    private static final Component TITLE = Component.translatable("havenede.container.golden_mechanical_sieve");
    ...
    public GoldenMechanicalSieveBlockEntity(BlockPos pos, BlockState state) {
        super(ModBlockEntities.GOLDEN_MECHANICAL_SIEVE.get(), pos, state, ItemHandler::new, HavenConfig.golden_mechanical_sieve_energyStorage);
        this.energyHelper = new EnergyHelper(HavenConfig.golden_mechanical_sieve_energyStorage);
    }
    ...
    protected void runMachineTick() {
        this.logic.sift((float)HavenConfig.golden_mechanical_sieve_speed, Long.MAX_VALUE);
    }

    protected int getEnergyConsumption() {
        return HavenConfig.golden_mechanical_sieve_energyConsumption;
    }
    ...
    public AbstractContainerMenu createMenu(int containerId, Inventory playerInventory, Player pPlayer) {
        return new GoldenMechanicalSieveMenu(containerId, playerInventory, this);
    }
    ...
    private static class ItemHandler extends ItemHelper {
        private final GoldenMechanicalSieveBlockEntity sieve;

        public ItemHandler(GoldenMechanicalSieveBlockEntity sieve) {
            super(22);
            this.sieve = sieve;
        }
