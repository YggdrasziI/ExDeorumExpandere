...
import net.cathienova.havenede.menu.mechanicalsieves.NetheriteMechanicalSieveMenu;
...
public class NetheriteMechanicalSieveBlockEntity extends AbstractMachineBlockEntity<NetheriteMechanicalSieveBlockEntity> implements SieveLogic.Owner {
    private static final Component TITLE = Component.translatable("havenede.container.netherite_mechanical_sieve");
    ...
    public NetheriteMechanicalSieveBlockEntity(BlockPos pos, BlockState state) {
        super(ModBlockEntities.NETHERITE_MECHANICAL_SIEVE.get(), pos, state, ItemHandler::new, HavenConfig.netherite_mechanical_sieve_energyStorage);
        this.energyHelper = new EnergyHelper(HavenConfig.netherite_mechanical_sieve_energyStorage);
    }
    ...
    protected void runMachineTick() {
        this.logic.sift((float)HavenConfig.netherite_mechanical_sieve_speed, Long.MAX_VALUE);
    }

    protected int getEnergyConsumption() {
        return HavenConfig.netherite_mechanical_sieve_energyConsumption;
    }
    ...
    public AbstractContainerMenu createMenu(int containerId, Inventory playerInventory, Player pPlayer) {
        return new NetheriteMechanicalSieveMenu(containerId, playerInventory, this);
    }
    ...
    private static class ItemHandler extends ItemHelper {
        private final NetheriteMechanicalSieveBlockEntity sieve;

        public ItemHandler(NetheriteMechanicalSieveBlockEntity sieve) {
            super(22);
            this.sieve = sieve;
        }
